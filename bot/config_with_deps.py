...
class TradingSettings:
    ...
    def __init__(self, **kwargs):
        ...
        self.min_trading_interval_seconds: int = kwargs.get(
            "min_trading_interval_seconds", 60
        )
        self.require_24h_data_before_trading: bool = kwargs.get(
...
class SystemSettings:
    ...
    def __init__(self, **kwargs):
        ...
        self.update_frequency_seconds: float = kwargs.get(
            "update_frequency_seconds", 30.0
        )

        # Load from environment
        self.dry_run = os.getenv("SYSTEM__DRY_RUN", "true").lower() in (
            "true",
            "1",
            "yes",
        )
...
class OmniSearchSettings:
    ...
    def __init__(self, **kwargs):
        ...
        self.rate_limit_requests_per_minute: int = kwargs.get(
        ...
        self.enable_correlation_analysis: bool = kwargs.get(
...
class Settings:
    ...
    def _load_functional_config(self) -> FunctionalConfig | None:
