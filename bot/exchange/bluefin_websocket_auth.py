...
from .bluefin_order_signature import BluefinOrderSigner, OrderSignatureError
...
class BluefinWebSocketAuthenticator:
    ...
    def _should_refresh_token(self) -> bool:
        ...
        time_until_expiration = (self._token_expires_at - datetime.now(UTC)).total_seconds()
...
def create_websocket_authenticator(private_key_hex: str) -> BluefinWebSocketAuthenticator:
    """
