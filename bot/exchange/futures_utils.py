...
class FuturesContractManager:
    ...
    async def get_active_futures_contract(self, base_currency: str = "ETH") -> Optional[str]:
        """
        ...
        try:
            ...
            for product in products:
                ...
                if base_currency in product_id and any(month in product_id for month in ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC']):
    ...
    def get_cached_contract(self) -> Optional[str]:
