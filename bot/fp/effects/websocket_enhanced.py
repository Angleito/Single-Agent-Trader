...
from ..types.effects import RetryPolicy, WebSocketConnection
...
class EnhancedWebSocketManager:
    ...
    def __init__(self, config: EnhancedConnectionConfig):
        ...
        self._message_queue: asyncio.Queue[MessageEnvelope] = asyncio.Queue(maxsize=10000)
            ...
            async with self._connection_lock:
                ...
                try:
                    ...
                    self._connection = await websockets.connect(
                        ...
                        ping_interval=self.config.heartbeat_interval if self.config.enable_ping_pong else None,
    ...
    def check_connection_health(self) -> IO[bool]:
        ...
        def check():
            ...
            if self._metrics.last_message_time:
                time_since_last_message = datetime.utcnow() - self._metrics.last_message_time
