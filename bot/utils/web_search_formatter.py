...
# Try relative imports first, fallback to creating mock classes if needed
try:
    ...
    class CorrelationAnalysis:
        def __init__(
            ...
            self.rolling_correlation_24h = rolling_correlation_24h
            self.rolling_correlation_7d = rolling_correlation_7d
            self.correlation_stability = correlation_stability
            self.regime_dependent_correlation = regime_dependent_correlation or {}
    ...
    class MarketRegime:
        def __init__(
            ...
            self.inflation_environment = inflation_environment
            self.interest_rate_trend = interest_rate_trend
            self.geopolitical_risk_level = geopolitical_risk_level
            self.crypto_adoption_momentum = crypto_adoption_momentum
            self.institutional_sentiment = institutional_sentiment
            self.regulatory_environment = regulatory_environment
            self.market_volatility_regime = market_volatility_regime
            self.liquidity_conditions = liquidity_conditions
    ...
    class RiskSentiment:
        def __init__(
            ...
            self.crypto_fear_greed = crypto_fear_greed
            self.social_sentiment_score = social_sentiment_score
            self.news_sentiment_score = news_sentiment_score
            self.funding_rates_sentiment = funding_rates_sentiment
            self.options_flow_sentiment = options_flow_sentiment
    ...
    class MomentumAlignment:
        def __init__(
            ...
            self.nasdaq_momentum_score = nasdaq_momentum_score
            self.momentum_divergences = momentum_divergences or []
            self.trend_strength_crypto = trend_strength_crypto
            self.trend_strength_nasdaq = trend_strength_nasdaq
            self.volume_momentum_alignment = volume_momentum_alignment
