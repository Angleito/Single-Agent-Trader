...
def run_integration_tests(verbose: bool = False, coverage: bool = False) -> bool:
    ...
    if coverage:
        cmd.extend(["--cov=bot", "--cov-report=html", "--cov-report=term", "--cov-append"])
    
    return run_command(cmd, "Integration Tests")


def run_omnisearch_specific_tests(verbose: bool = False, coverage: bool = False) -> bool:
...
Examples:
  ...
  python scripts/run_omnisearch_tests.py --quality
    ...
    parser.add_argument("--omnisearch", action="store_true", help="Run OmniSearch-specific tests")
    ...
    if not any([args.unit, args.integration, args.omnisearch, args.performance, 
                args.all, args.quality, args.report]):
        args.all = True
