...
def test_market_data_types():
    ...
    try:
        ...
        from bot.trading_types import MarketData, Position
...
def test_enhanced_market_data():
    ...
    try:
        ...
        available_items = [
            item for item in dir(enhanced_market_data) if not item.startswith("_")
        ]
...
def test_performance_monitoring():
    ...
    try:
        ...
        print(
            f"✅ Current metrics: {len(metrics) if isinstance(metrics, dict) else type(metrics)}"
        )
