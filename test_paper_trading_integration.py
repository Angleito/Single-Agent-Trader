    ...
    try:
        ...
        try:
            ...
            if settings.system.dry_run:
                ...
                print(
                    "⚠️  System configured for live trading - ensure this is intentional"
                )
        ...
        try:
            ...
            print(
                f"   Market order: {market_order.symbol} {market_order.side} {market_order.size}"
            )
            print(
                f"   Limit order: {limit_order.symbol} {limit_order.side} ${limit_order.price} size:{limit_order.size}"
            )
