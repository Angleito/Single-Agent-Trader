...
def test_vumanchu_indicators():
    ...
    try:
        ...
        print(f'✅ Created {len(market_data)} data points from {market_data.timestamp.min()} to {market_data.timestamp.max()}')
        ...
        if hasattr(indicators, 'calculate'):
            ...
            available_methods = [method for method in dir(indicators) if not method.startswith('_')]
