...
class TestOrderManagerCompatibility:
    ...
    def test_callback_registration_api_compatibility(self, order_manager, settings_mock):
    ...
    @pytest.mark.asyncio
    async def test_async_lifecycle_api_compatibility(self, order_manager, settings_mock):
    ...
    def test_state_persistence_api_compatibility(self, order_manager, temp_dir, settings_mock):
