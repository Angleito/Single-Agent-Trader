...
from bot.fp.events.base import Event, EventType, EventMetadata, SystemEvent
from bot.fp.events.functional_store import (
    FunctionalEventStore, create_event_store, store_alert, store_audit_entry
)
from bot.fp.events.serialization import EventSerializer, EventDeserializer
from bot.fp.types.events import (
    AlertLevel, SystemComponent, NotificationChannel,
    AlertTriggered, NotificationSent, ConfigurationChanged,
    SystemPerformanceMetric, ErrorOccurred, AuditTrailEntry,
    create_alert_event, create_audit_event
)
...
class TestEventBasics:
    ...
    def test_event_metadata_chaining(self):
        ...
        chained_metadata = (base_metadata
...
class TestFunctionalEventTypes:
    ...
    def test_configuration_changed_event(self):
        ...
        config_change = ConfigurationChanged(
            ...
            affected_components=[SystemComponent.RISK_MANAGER, SystemComponent.ORDER_MANAGER],
