...
class TestFunctionalIndicatorProcessor:
    ...
    def test_integration_adapter(self):
        ...
        current_indicators = integration_adapter.process_candles_and_get_current(
            candles
        )
...
class TestIntegrationScenarios:
    ...
    async def test_end_to_end_data_flow(self):
        ...
        functional_processor, provider = create_integrated_market_data_system(
            "BTC-USD", "1m"
        )
        ...
        with patch("bot.data.market.MarketDataProvider") as MockProvider:
            ...
            # Verify connection
            assert (
                functional_processor.get_connection_state().status
    ...
    def test_data_quality_metrics(self):
        ...
        quality = create_data_quality(
            messages_received=100, messages_processed=95, validation_failures=5
        )
