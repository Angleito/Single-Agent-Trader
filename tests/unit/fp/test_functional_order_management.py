...
if FP_AVAILABLE:
    from bot.fp.orders import (
        ...
        calculate_order_success_patterns,
        cancel_order,
        create_order,
...
class TestOrderTypes(FPTestBase):
    ...
    def test_order_state_immutability(self):
        ...
        params = OrderParameters.create("BTC-USD", "BUY", "LIMIT", 1.0, 50000.0).value
...
class TestOrderManagerState(FPTestBase):
    ...
    def test_cancel_all_orders(self):
        ...
        # Add multiple orders
        params2 = OrderParameters.create("ETH-USD", "SELL", "LIMIT", 2.0, 3000.0).value
...
class TestOrderAnalytics(FPTestBase):
    ...
    def setup_method(self):
        ...
        # Create filled order
        params1 = OrderParameters.create("BTC-USD", "BUY", "LIMIT", 1.0, 50000.0).value
...
class TestAdvancedOrderTypes(FPTestBase):
    ...
    def test_order_state_percentage_calculations(self):
        ...
        params_result = OrderParameters.create(
            symbol="BTC-USD", side="BUY", order_type="MARKET", quantity=2.0
        )
...
class TestAdvancedOrderAnalytics(FPTestBase):
    ...
    def test_calculate_order_success_patterns(self):
        ...
        try:
            ...
            market_buy = OrderParameters.create(
                "BTC-USD", "BUY", "MARKET", 1.0
            ).success()
            ...
            # Failed LIMIT SELL
            limit_sell = OrderParameters.create(
                "BTC-USD", "SELL", "LIMIT", 1.0, 60000.0
            ).success()
...
class TestOrderCompatibilityAndMigration(FPTestBase):
    ...
    def test_order_type_compatibility(self):
        ...
        assert fp_order.status.value in [
            "PENDING",
            "OPEN",
            "FILLED",
            "CANCELLED",
