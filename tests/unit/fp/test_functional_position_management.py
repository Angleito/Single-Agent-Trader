...
class TestImmutablePositionTypes:
    ...
    def test_portfolio_immutability(self):
        ...
        portfolio = Portfolio(positions=(position,), cash_balance=Decimal("10000.0"))
    ...
    def test_portfolio_calculations(self):
        ...
        portfolio = Portfolio(
            positions=(btc_position, eth_position), cash_balance=Decimal("5000.0")
        )
...
class TestFunctionalPositionOperations:
    ...
    def test_open_position_functional(self):
        ...
        portfolio = Portfolio(positions=(), cash_balance=Decimal("100000.0"))
    ...
    def test_close_position_functional(self):
        ...
        portfolio = Portfolio(positions=(position,), cash_balance=Decimal("0.0"))
    ...
    def test_portfolio_price_updates_functional(self):
        ...
        portfolio = Portfolio(
            positions=(btc_position, eth_position), cash_balance=Decimal("10000.0")
        )

        # Update prices
        price_updates = {"BTC-USD": Decimal("52000.0"), "ETH-USD": Decimal("2900.0")}
...
class TestPropertyBasedPositionTests:
    ...
    def test_margin_requirement_properties(self, position_value, leverage):
        ...
        if leverage > 1:
            lower_leverage_margin = calculate_margin_requirement(
                position_value, leverage / 2
            )
...
class TestFunctionalPositionPersistence:
    ...
    def test_portfolio_serialization(self):
        ...
        portfolio = Portfolio(positions=positions, cash_balance=Decimal("25000.0"))
        ...
        for orig, recon in zip(
            portfolio.positions, reconstructed.positions, strict=False
        ):
...
def validate_position_data(
    symbol: str, side: str, size: Decimal, entry_price: Decimal
) -> Result[dict, str]:
