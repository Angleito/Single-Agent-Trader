...
class TestMarketContextCreation:
    ...
    def test_create_market_context_basic(self, sample_market_state, sample_vumanchu_state):
...
class TestPromptGeneration:
    ...
    def bullish_context(self):
        ...
        return LLMContext(
            ...
            recent_trades=[
                {"action": "LONG", "price": 2950, "pnl": 0.034}
            ],
        )
    ...
    def bearish_context(self):
        ...
        return LLMContext(
            ...
            recent_trades=[
                {"action": "SHORT", "price": 50500, "pnl": 0.049}
            ],
        )
    ...
    def test_generate_trading_prompt_bullish(self, bullish_context, trading_params):
        ...
        prompt = generate_trading_prompt(bullish_context, trading_params, include_examples=True)
    ...
    def test_generate_trading_prompt_bearish(self, bearish_context, trading_params):
        ...
        prompt = generate_trading_prompt(bearish_context, trading_params, include_examples=False)
    ...
    def test_generate_trading_prompt_neutral_conditions(self, trading_params):
        ...
        assert "no recent trades" in prompt.lower() or "recent trading activity" not in prompt
...
class TestConfidenceAdjustment:
    ...
    def test_adjust_confidence_counter_trend(self):
        ...
        adjusted = adjust_confidence_by_market_conditions(long_response, downtrend_market)
...
class TestDecisionValidation:
    ...
    def test_validate_low_confidence_rejection(self, trading_params, sample_market_state):
    ...
    def test_validate_oversized_position_rejection(self, trading_params, sample_market_state):
    ...
    def test_validate_invalid_stop_loss_short(self, trading_params, sample_market_state):
    ...
    def test_validate_hold_decision_always_valid(self, trading_params, sample_market_state):
...
class TestTypeConverter:
    ...
    def test_llm_response_to_trade_action_no_suggested_params(self, sample_market_state):
        ...
        with patch.object(settings.llm, 'provider', 'openai'):
            with patch.object(settings.llm, 'model_name', 'gpt-4'):
                with patch.object(settings.llm, 'openai_api_key') as mock_key:
                    ...
                    strategy._call_llm = AsyncMock(return_value="""
                    {
                        "action": "HOLD",
                        "confidence": 0.8,
                    ...
                    response = await strategy.analyze_market_functional(sample_market_state)
