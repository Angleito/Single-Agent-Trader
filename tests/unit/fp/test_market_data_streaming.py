...
from bot.fp.types.trading import FunctionalMarketData, FuturesMarketData, TradingIndicators
from bot.fp.types.result import Result, Ok, Err
from bot.fp.effects.io import IOEither, AsyncIO
from bot.fp.effects.market_data import (
    MarketDataStream,
    MarketDataAggregator,
    StreamingConfig,
    create_market_data_stream,
    create_high_frequency_stream
)
...
class TestTradeAggregator:
    ...
    def test_trade_aggregation_1_second(self):
        ...
        trades = [
            ...
            {"price": 50010, "size": 0.2, "timestamp": base_time + timedelta(milliseconds=300)},
            {"price": 49995, "size": 0.15, "timestamp": base_time + timedelta(milliseconds=600)},
            {"price": 50005, "size": 0.1, "timestamp": base_time + timedelta(milliseconds=900)},
        ]
