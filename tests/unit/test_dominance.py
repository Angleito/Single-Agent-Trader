...
from bot.data.dominance import DominanceDataProvider, DominanceData
...
class TestDominanceDataProvider:
    ...
    @pytest.mark.asyncio
    async def test_fetch_coingecko_dominance(self, dominance_provider, mock_coingecko_response):
    ...
    @pytest.mark.asyncio
    async def test_get_market_sentiment(self, dominance_provider, sample_dominance_data):
