...
class TestFinancialSentimentService:
    ...
    def test_extract_crypto_indicators_technical_patterns(self):
        ...
        assert (
            "rsi" in indicators.indicator_signals
            or "macd" in indicators.indicator_signals
        )
    ...
    def test_extract_price_levels_support_resistance(self):
        ...
        resistance_levels = service._extract_price_levels(
            text, ["resistance", "ceiling"]
        )
    ...
    def test_generate_trading_implications_bullish(self):
        ...
        sentiment_result = SentimentResult(sentiment_score=0.7, confidence=0.9)
    ...
    def test_generate_trading_implications_bearish(self):
        ...
        sentiment_result = SentimentResult(sentiment_score=-0.6, confidence=0.8)
    ...
    def test_generate_trading_implications_low_confidence(self):
        ...
        sentiment_result = SentimentResult(sentiment_score=0.5, confidence=0.2)
    ...
    async def test_concurrent_sentiment_analysis(self):
        ...
        news_items = [
            {"title": f"News item {i}", "content": f"Content {i}"} for i in range(10)
        ]
    ...
    def test_aggregation_weighted_sentiment(self):
        ...
        news_items = [{"title": "Bullish News"}, {"title": "Bearish News"}]
...
class TestFinancialSentimentServiceIntegration:
    ...
    async def test_full_analysis_workflow_bullish(self, sample_bullish_news):
        ...
        # Extract indicators
        combined_text = " ".join(
            [item["title"] + " " + item["content"] for item in sample_bullish_news]
        )
    ...
    async def test_full_analysis_workflow_bearish(self, sample_bearish_news):
        ...
        combined_text = " ".join(
            [item["title"] + " " + item["content"] for item in sample_bearish_news]
        )
    ...
    async def test_full_analysis_workflow_mixed(self, sample_mixed_news):
        ...
        combined_text = " ".join(
            [item["title"] + " " + item["content"] for item in sample_mixed_news]
        )
