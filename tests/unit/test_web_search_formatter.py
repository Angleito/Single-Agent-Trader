...
try:
    ...
    from bot.analysis.market_context import CorrelationAnalysis, MarketRegime, RiskSentiment, MomentumAlignment
except ImportError:
    ...
    class CorrelationAnalysis:
        def __init__(self, **kwargs):
            ...
            self.regime_dependent_correlation = kwargs.get('regime_dependent_correlation', {})
...
class TestFormattedContent:
    ...
    def test_formatted_content_creation(self):
        ...
        content = FormattedContent(
            ...
            key_insights=["Institutional adoption accelerating", "Technical breakout confirmed"],
...
class TestWebSearchFormatter:
    ...
    def test_formatter_initialization_custom(self):
        ...
        formatter = WebSearchFormatter(max_tokens_per_section=300, max_total_tokens=1500)
    ...
    def test_calculate_authority_score_high_authority(self):
        ...
        score = formatter._calculate_authority_score("https://bloomberg.com/bitcoin-news")
    ...
    def test_extract_item_insights_institutional(self):
        ...
        assert any("institutional" in insight.lower() or "whale" in insight.lower() for insight in insights)
    ...
    def test_generate_correlation_implications(self):
        ...
        assert "systematic risk" in implications.lower() or "diversification" in implications.lower()
...
class TestWebSearchFormatterIntegration:
    ...
    @pytest.mark.asyncio
    async def test_complete_sentiment_formatting_workflow(self, sample_sentiment_result):
    ...
    @pytest.mark.asyncio
    async def test_complete_correlation_formatting_workflow(self, sample_correlation_analysis):
        """Test complete correlation formatting workflow."""
        formatter = WebSearchFormatter()
        
        result = await formatter.format_correlation_analysis(sample_correlation_analysis)
    ...
    async def test_token_optimization_workflow(self):
        ...
        large_news_items = [
            {
                ...
                "content": f"This is a very long news article with extensive content that goes on and on about market conditions and trading implications. Article number {i} contains detailed analysis and comprehensive market insights that would normally be very valuable for trading decisions." * 5,
        ...
        assert estimated_tokens <= formatter.max_total_tokens * 1.1  # Allow small margin
    ...
    async def test_error_resilience_workflow(self):
        ...
        invalid_sentiment = type('InvalidSentiment', (), {
            'sentiment_score': 'invalid',
            'confidence': None,
            'key_themes': None
        })()
        
        invalid_correlation = type('InvalidCorrelation', (), {
        ...
        correlation_result = await formatter.format_correlation_analysis(invalid_correlation)
