...
class FunctionalTypesValidator:
    ...
    def validate_basic_types(self) -> None:
        ...
        try:
            ...
            self.log_test("Long Signal Creation", True, f"Created with confidence {long_signal.confidence}")
            
            # Test invalid confidence
            try:
                Long(confidence=1.5, size=0.25, reason="Invalid")
                self.log_test("Long Signal Validation", False, "Should reject invalid confidence")
            except ValueError:
                self.log_test("Long Signal Validation", True, "Correctly rejected invalid confidence")
        ...
        try:
            ...
            self.log_test("Short Signal Creation", True, f"Created with size {short_signal.size}")
        except Exception as e:
            self.log_test("Short Signal Creation", False, f"Error: {e}")
        
        # Test MarketMake signal
        try:
            mm_signal = MarketMake(bid_price=50000, ask_price=50100, bid_size=0.1, ask_size=0.1)
            spread = mm_signal.spread
            mid_price = mm_signal.mid_price
            self.log_test("MarketMake Signal", True, f"Spread: {spread}, Mid: {mid_price}")
        except Exception as e:
    ...
    def validate_order_types(self) -> None:
        ...
        try:
            ...
            stop_order = StopOrder(symbol="BTC-USD", side="sell", stop_price=45000, size=0.1)
        ...
        try:
            ...
            self.log_test("Futures Limit Order", True, f"Notional: ${notional}, Position: ${position_value}")
    ...
    def validate_market_data(self) -> None:
        ...
        try:
            ...
            try:
                ...
                self.log_test("Market Data Validation", False, "Should reject invalid OHLC")
            except ValueError:
                self.log_test("Market Data Validation", True, "Correctly rejected invalid OHLC")
        ...
        try:
            ...
            self.log_test("Futures Market Data", True, 
    ...
    def validate_positions_and_accounts(self) -> None:
        ...
        try:
            ...
            self.log_test("Margin Info", True, 
        ...
        try:
            ...
            self.log_test("Futures Account", True, 
    ...
    def validate_risk_management(self) -> None:
        ...
        try:
            ...
            self.log_test("Risk Limits Creation", True, 
        ...
        try:
            ...
            compliant = risk_metrics.is_within_risk_limits(create_conservative_risk_limits())
            
            self.log_test("Risk Metrics", True, 
    ...
    def validate_indicators(self) -> None:
        ...
        try:
            ...
            self.log_test("Trading Indicators", True, 
    ...
    def validate_signal_to_order_conversion(self) -> None:
        ...
        try:
            ...
            self.log_test("Long Signal Conversion", True, 
            ...
            self.log_test("Short Signal Conversion", True, 
                         f"Generated {len(orders)} orders from Short signal")
            
            # Test MarketMake signal conversion
            mm_signal = MarketMake(bid_price=49950, ask_price=50050, bid_size=0.1, ask_size=0.1)
            orders = convert_trade_signal_to_orders(mm_signal, "BTC-USD", 50000)
            
            self.log_test("MarketMake Signal Conversion", True, 
    ...
    def validate_comprehensive_market_state(self) -> None:
        ...
        try:
            ...
            self.log_test("Market State Creation", True, 
            ...
            self.log_test("Market State Update", True, 
    ...
    def validate_type_adapters(self) -> None:
        ...
        try:
            ...
            # Test adaptation
            functional_market_data = self.adapter.adapt_market_data_to_functional(legacy_market_data)
            functional_position = self.adapter.adapt_position_to_functional(legacy_position)
            functional_indicators = self.adapter.adapt_indicators_to_functional(legacy_indicators)
            
            self.log_test("Legacy to Functional Adaptation", True, 
                         f"Adapted market data, position, and indicators successfully")
            ...
            self.log_test("Functional State Creation", True, 
                         f"Created state for {functional_state.symbol}")
            
            # Test conversion back to legacy
            legacy_format = self.adapter.convert_functional_state_to_legacy(functional_state)
            
            self.log_test("Functional to Legacy Conversion", True, 
                         f"Converted back to legacy format")
    ...
    def validate_trading_accuracy(self) -> None:
        ...
        try:
            ...
            self.log_test("P&L Calculation Accuracy", price_accurate and pnl_accurate,
        ...
        try:
            ...
            self.log_test("Margin Calculation Accuracy", margin_accurate,
